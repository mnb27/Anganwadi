...
class ViewANMUserAdapter(var context: Context, var detailsList: MutableList<ANMUser>):
    RecyclerView.Adapter<ViewANMUserAdapter.DetailsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewANMUserAdapter.DetailsViewHolder, position: Int) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ViewANMUserAdapter.DetailsViewHolder {
    ...
    fun setList(list: MutableList<ANMUser>){
        detailsList = list
