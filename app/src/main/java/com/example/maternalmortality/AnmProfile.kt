...
import kotlinx.android.synthetic.main.activity_profile_asha.*
import kotlinx.android.synthetic.main.change_password_layout.view.*
import org.jetbrains.anko.db.NULL
import java.util.*


class AnmProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var profileref = storageref!!.child("AnmPics/"+user_email)
        ...
        fireStore.collection("ANMUser").whereEqualTo("email",user_email).get()
...
//        val filename = UUID.randomUUID().toString()
        val ref = FirebaseStorage.getInstance().getReference("/AnmPics/"+filename)
