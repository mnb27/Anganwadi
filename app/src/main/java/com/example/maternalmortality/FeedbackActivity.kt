...
class FeedbackActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val q1: EditText = findViewById(R.id.one)
        val q2: EditText = findViewById(R.id.two)
        val q3: EditText = findViewById(R.id.three)
        val  q4: EditText = findViewById(R.id.four)
        ...
        saveButton.setOnClickListener {
            var q1 = q1.text.toString()
            var q2 = q2.text.toString()
            var q3 = q3.text.toString()
            var q4 = q4.text.toString()
